...
import com.example.irina.test.CaffeMobile;
...
public class MainActivity extends Activity implements CNNListener, OnClickListener{
    ...
    private ImageView ivCaptured, ivResult;
    ...
    String modelDir = sdcard.getAbsolutePath() + "/caffe_mobile/enet_model";
    String modelProto = modelDir + "/enet_deploy_final.prototxt";
    String modelBinary = modelDir + "/cityscapes_weights.caffemodel";
    String LUT_file=modelDir +"/cityscapes19.png";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLabel.setText("Time taken: "+String.valueOf(0));
    }
    ...
    private class CNNTask extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... strings) {
            ...
            caffeMobile.predictImage(strings[0],LUT_file,resultMat.getNativeObjAddr());
            return 0;
        }
    ...
    public void onTaskCompleted(int result) {
        ...
        Log.d(LOG_TAG, String.valueOf(bmpResult.getHeight()));
        Log.d(LOG_TAG, String.valueOf(bmpResult.getWidth()));
